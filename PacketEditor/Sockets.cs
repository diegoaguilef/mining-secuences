    ...
    public partial class Sockets : Form
    {
        ...
        private void replayEditorToolStripMenuItem_Click(object sender, EventArgs e)
        {
            if (dgridSockets.SelectedRows.Count != 0)
            {
                ...
                ReplayEditor frmChReplay = new ReplayEditor(zero, Int32.Parse(dgridSockets.SelectedRows[0].Cells["socket"].Value.ToString(), System.Globalization.NumberStyles.AllowHexSpecifier), pipeOut);
                if (this.TopMost == true)
